...
from ansys.scade.pyalmgw import __version__

# Project information
project = 'ansys-scade-pyalmgw'
...
html_short_title = html_title = 'Ansys SCADE ALM Gateway Python Toolbox'

# multi-version documentation
cname = os.getenv('DOCUMENTATION_CNAME', 'pyalmgw.scade.docs.pyansys.com')
"""The canonical name of the webpage hosting the documentation."""

# specify the location of your github repo
html_theme_options = {
    'github_url': 'https://github.com/ansys/scade-pyalmgw',
...
if switcher_version != 'dev':
    linkcheck_ignore.append(f'https://github.com/ansys/scade-pyalmgw/releases/tag/v{__version__}')
