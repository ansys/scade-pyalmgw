...
-------------------------
Installing Ansys SCADE ALM Gateway Python Toolbox in developer mode allows you to modify the
...
#. Clone the ``ansys-scade-pyalmgw`` repository:
   ...
   .. code:: bash
      ...
      git clone https://github.com/ansys/scade-pyalmgw
...
Test
----
Ansys SCADE ALM Gateway Python Toolbox uses `tox`_ for testing. This tool allows you to
...
Use ``pre-commit``
^^^^^^^^^^^^^^^^^^
Ansys SCADE ALM Gateway Python Toolbox follows the PEP8 standard as outlined in
...
Use the `Ansys SCADE ALM Gateway Python Toolbox Issues <https://github.com/ansys/scade-pyalmgw/issues>`_
...
.. _wheel file: https://github.com/ansys/scade-pyalmgw/releases